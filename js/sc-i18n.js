...
const AR = {
  ...
  'Hand over on your terms': 'التسليم بشروطك',
  'Scroll down to just listed': 'انزل إلى القطع المضافة حديثاً',
  'We restored your unfinished draft.': 'استعدنا مسودتك غير المكتملة.',
  'How Buyer Protection works': 'كيف تعمل حماية المشتري',
  'Buying safely': 'الشراء بأمان',
  'Shop the collective': 'تسوّق الكوليكتيف',
  'Why us': 'لماذا نحن',
  'Why SecondChance.': 'لماذا سيكند تشانس.',
  'Read the racks like a magazine.': 'تصفّح الرفوف كما تتصفح مجلة.',
  'Shop the edit': 'تسوّق التشكيلة',
  'Your closet is an untapped wardrobe.': 'خزانتك كنز غير مستغل.',
  'KEEP 88% OF EVERY SALE': 'احتفظ بـ88٪ من كل عملية بيع',
  'Upload your piece': 'ارفع قطعتك',
  'Set your price': 'حدّد سعرك',
  'We connect you with buyers': 'نوصلك بالمشترين',
  'Get paid': 'استلم أرباحك',
  'Subscribe': 'اشترك',
  'Share': 'مشاركة',
  'You may also like': 'قد يعجبك أيضًا',
  'Complete the look': 'أكمل الإطلالة',
  'My saved': 'محفوظاتي',
  'Just added': 'أُضيفت للتو',
  'Almost gone': 'على وشك النفاد',
  'Others interested 👀': 'آخرون مهتمون 👀',
  ...
  'A slow pan in good light': 'لقطة بطيئة بإضاءة جيدة',
  'A slow pan in good light, optional': 'لقطة بطيئة بإضاءة جيدة، اختياري',
  'Cover': 'الغلاف',
  'Make cover': 'اجعلها الغلاف',
  'Try again': 'حاول مرة أخرى',
  'Start selling': 'ابدأ البيع الآن',
