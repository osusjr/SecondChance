/* ============================================================
   RAÉCAE — Archive Catalogue
   Demonstration inventory for the concept site. Every piece
   carries an AI-written story, an authentication record and
   a digital product passport.
   ============================================================ */

window.RAECAE_PRODUCTS = [
  {
    id: "hermes-kelly-28",
    brand: "Hermès",
    title: "Kelly 28 Retourné, Box Calf",
    category: "Bags",
    era: "Vintage",
    year: "1998",
    price: 8400,
    condition: "Excellent",
    conditionNote: "Light patina on hardware consistent with age. Corners intact, structure firm, interior immaculate.",
    art: "handbag",
    status: "verified",
    confidence: 98.6,
  ...
  },
  {
    ...
    brand: "Chanel",
    title: "Classic Flap Medium, Lambskin",
    category: "Bags",
    era: "Contemporary",
    year: "2011",
    price: 5900,
    condition: "Very Good",
    conditionNote: "Quilting full and even. Minor softening at base corners. Chain and turnlock bright.",
    art: "shoulderbag",
    status: "verified",
    confidence: 97.2,
    passport: "RC-2026-0212",
    material: "Lambskin, gold-tone chain hardware",
  ...
  },
  {
    id: "burberry-trench",
    brand: "Burberry",
    title: "Westminster Heritage Trench",
    category: "Outerwear",
    era: "Contemporary",
    year: "2015",
    price: 640,
    condition: "Excellent",
    conditionNote: "Gabardine crisp, cuff straps unworn, check lining unmarked. Professionally pressed.",
    art: "trench",
    status: "verified",
    confidence: 99.1,
    passport: "RC-2026-0178",
    material: "Cotton gabardine, horn-look buttons",
  ...
  },
  {
    ...
    price: 980,
    condition: "Excellent",
    conditionNote: "No pulls or press-shine. Canvas structure intact, buttons original.",
    art: "blazer",
    status: "verified",
    confidence: 96.8,
    passport: "RC-2026-0193",
  ...
  },
  {
    ...
    brand: "Cartier",
    title: "Tank Must, Large Model",
    category: "Watches & Jewellery",
    era: "Contemporary",
    year: "2021",
    price: 2750,
    condition: "Very Good",
    conditionNote: "Case unpolished, hairlines on clasp only. Movement serviced, papers present.",
    art: "watch",
    status: "verified",
    confidence: 99.4,
    passport: "RC-2026-0164",
    material: "Steel case, quartz movement, leather strap",
  ...
  },
  {
    ...
    brand: "Gucci",
    title: "1953 Horsebit Loafers",
    category: "Shoes",
    era: "Vintage",
    year: "1989",
    price: 420,
    condition: "Good",
    conditionNote: "Soles refreshed by a master cobbler. Leather supple, horsebit bright, patina rich.",
    art: "loafers",
    status: "verified",
    confidence: 95.3,
    passport: "RC-2026-0201",
    material: "Black calf leather, gold-tone horsebit",
  ...
  },
  {
    id: "hermes-carre-90",
    brand: "Hermès",
    title: "Carré 90 — Brides de Gala",
    category: "Accessories",
    era: "Vintage",
    year: "1985",
    price: 310,
    condition: "Very Good",
    conditionNote: "Hand-rolled hem intact. Silk lustrous, one faint storage crease.",
    art: "scarf",
    status: "verified",
    confidence: 97.9,
    passport: "RC-2026-0155",
  ...
  },
  {
    ...
    price: 720,
    condition: "Excellent",
    conditionNote: "Silk charmeuse flawless, seams original, no alterations detected.",
    art: "dress",
    status: "verified",
    confidence: 96.1,
    passport: "RC-2026-0188",
    material: "Silk charmeuse, bias cut",
  ...
  {
    id: "celine-sunglasses",
    brand: "Celine",
    title: "Oversized Acetate Sunglasses",
    category: "Accessories",
    era: "Contemporary",
    year: "2019",
    price: 180,
    condition: "Very Good",
    conditionNote: "Lenses scratch-free, hinges tight, original case and cloth included.",
    art: "sunglasses",
    status: "verified",
    confidence: 94.7,
    passport: "RC-2026-0224",
    material: "Black acetate, CR-39 lenses",
  ...
  },
  {
    ...
    price: 540,
    condition: "Very Good",
    conditionNote: "Uppers unmarked, soles show light wear. Shape holds perfectly on the last.",
    art: "boots",
    status: "verified",
    confidence: 96.4,
    passport: "RC-2026-0239",
  ...
  },
  {
    id: "mikimoto-pearls",
    brand: "Mikimoto",
    title: "Akoya Pearl Double Strand",
    category: "Watches & Jewellery",
    era: "Vintage",
    year: "1978",
    price: 1850,
    condition: "Excellent",
    conditionNote: "Lustre exceptional, silk thread professionally re-knotted, clasp original.",
    art: "necklace",
    status: "verified",
    confidence: 98.1,
    passport: "RC-2026-0132",
    material: "Akoya cultured pearls, 18k clasp",
  ...
  {
    id: "prada-biker-jacket",
    brand: "Prada",
    title: "Vintage Nappa Biker Jacket",
    category: "Outerwear",
    era: "Vintage",
    year: "1999",
    price: 860,
    condition: "Very Good",
    conditionNote: "Nappa soft with even wear. Zips original and smooth. Lining sound.",
    art: "jacket",
    status: "verified",
    confidence: 95.8,
    passport: "RC-2026-0170",
    material: "Nappa leather, Riri zips",
...
/* Categories used by the archive filters */
window.RAECAE_CATEGORIES = ["All", "Bags", "Outerwear", "Tailoring", "Dresses", "Shoes", "Watches & Jewellery", "Accessories"];
window.RAECAE_ERAS = ["All", "Vintage", "Contemporary"];

/* Helpers */
window.raecaeFindProduct = function (id) {
  return window.RAECAE_PRODUCTS.find(function (p) { return p.id === id; }) || null;
};
window.raecaeMoney = function (n) {
